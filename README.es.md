...
| Escritorio |
| --- |
| ![UI de sesión del espacio de trabajo](docs/assets/screenshot.png) |

| Tablet | Móvil |
| --- | --- |
| ![UI de espacio de trabajo en tablet](docs/assets/tablet.webp) | ![UI de árbol de archivos en móvil](docs/assets/mobile.webp) |
