...
- Aim for 100% coverage and statements.
- If 100% coverage and statements is difficult to achieve, first suspect that the code structure is hard to test rather than the test design.
