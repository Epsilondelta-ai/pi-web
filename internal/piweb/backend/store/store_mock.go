...
func NewMockStore() *Store {
	...
	return &Store{workspaces: workspaces, files: map[string][]FileNode{"pi-mono": files, "openclaw": files, "dotfiles": files, "design-system": files}, conversations: map[string][]Message{"8e7c-44ff": conversation}, workspacePath: map[string]string{"pi-mono": ".", "openclaw": ".", "dotfiles": ".", "design-system": "."}, sessionFiles: map[string]string{}, sessionCWD: map[string]string{"8e7c-44ff": "."}, workspaceSessionDir: map[string]string{
		"pi-mono": "/__pi_web_mock_sessions__/pi-mono", "openclaw": "/__pi_web_mock_sessions__/openclaw",
		"dotfiles": "/__pi_web_mock_sessions__/dotfiles", "design-system": "/__pi_web_mock_sessions__/design-system",
	}, sessionDirModTime: map[string]time.Time{}, refreshDisabledWorkspace: map[string]bool{
		"pi-mono": true, "openclaw": true, "dotfiles": true, "design-system": true,
	}}
}
