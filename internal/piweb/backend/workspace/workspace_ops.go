...
func CloneGitWorkspace(ctx context.Context, store WorkspaceOpStore, req shared.CloneWorkspaceRequest) (shared.Workspace, string, error) {
	parent, err := ValidatePath(req.ParentPath)
	if err != nil {
