...
func TestCoverageServerHandlers(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{http.MethodPost, "/api/workspaces/" + workspace.ID + "/files/create", `{bad`, http.StatusBadRequest},
		{http.MethodPost, "/api/workspaces/" + workspace.ID + "/files/create", `{"path":"created.txt","kind":"file","content":"new"}`, http.StatusOK},
		{http.MethodPatch, "/api/workspaces/" + workspace.ID + "/files/rename", `{"oldPath":"created.txt","newPath":"renamed.txt"}`, http.StatusOK},
		{http.MethodPost, "/api/workspaces/" + workspace.ID + "/files/upload", `{"path":"upload.bin","content":"aGk="}`, http.StatusOK},
		{http.MethodDelete, "/api/workspaces/" + workspace.ID + "/files/delete", `{"path":"renamed.txt"}`, http.StatusOK},
