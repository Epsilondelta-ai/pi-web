...
O instalador também instala os plugins confiáveis padrão: notificações toast, navegador de arquivos, visualizador Git e barra lateral. Defina `PI_WEB_INSTALL_DEFAULT_PLUGINS=never` para ignorá-los.
