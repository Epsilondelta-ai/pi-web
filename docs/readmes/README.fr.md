...
L'installateur installe aussi les plugins de confiance par défaut : notifications toast, navigateur de fichiers, visionneuse Git et barre latérale. Définissez `PI_WEB_INSTALL_DEFAULT_PLUGINS=never` pour les ignorer.
