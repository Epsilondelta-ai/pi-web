...
const EN_MESSAGES = {
  ...
  emptyTitlePrefix: "new session in",
  emptyTipShell: "run shell commands",
  emptyTipFiles: "attach files",
  emptyTipCommands: "use commands or skills",
  emptyTipDrop: "drag & drop files/images",
