...
export const workspaceRenderMethods = {
  ...
  workspaceGroupTemplate(workspace, open) {
    ...
    return [
      ...
      `<span class="ws-meta" aria-label="${workspace.sessionCount} sessions"><span class="ws-count">${workspace.sessionCount}</span><span class="ws-count-label">sessions</span></span></button>`,
