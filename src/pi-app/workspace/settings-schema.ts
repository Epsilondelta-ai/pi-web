...
export const SETTINGS_FIELDS = [
  ...
  { path: "terminal.showImages", label: "Show images", type: "boolean" },
  { path: "terminal.imageWidthCells", label: "Image width", type: "numberSelect", values: ["60", "80", "120"] },
  { path: "images.autoResize", label: "Auto-resize images", type: "boolean" },
  { path: "images.blockImages", label: "Block images", type: "boolean" },
  { path: "enableSkillCommands", label: "Skill commands", type: "boolean" },
  { path: "showHardwareCursor", label: "Show hardware cursor", type: "boolean" },
  { path: "editorPaddingX", label: "Editor padding", type: "numberSelect", values: ["0", "1", "2", "3"] },
  { path: "autocompleteMaxVisible", label: "Autocomplete max items", type: "numberSelect", values: ["3", "5", "7", "10", "15", "20"] },
  { path: "terminal.clearOnShrink", label: "Clear on shrink", type: "boolean" },
  { path: "terminal.showTerminalProgress", label: "Terminal progress", type: "boolean" },
  ...
  { path: "transport", label: "Transport", type: "select", values: ["sse", "websocket", "websocket-cached", "auto"] },
  { path: "hideThinkingBlock", label: "Hide thinking", type: "boolean" },
  { path: "collapseChangelog", label: "Collapse changelog", type: "boolean" },
  { path: "quietStartup", label: "Quiet startup", type: "boolean" },
  { path: "enableInstallTelemetry", label: "Install telemetry", type: "boolean" },
  { path: "doubleEscapeAction", label: "Double-escape action", type: "select", values: ["tree", "fork", "none"] },
  { path: "treeFilterMode", label: "Tree filter mode", type: "select", values: ["default", "no-tools", "user-only", "labeled-only", "all"] },
